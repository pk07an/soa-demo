...
import com.meila.common.security.SecureUtil;
...
public class HttpRequest extends HttpBase<HttpRequest> {
    ...
    public HttpRequest body(byte[] content, String contentType) {
        ...
        return body(StringUtils.str(content, charset));
    }
    // ---------------------------------------------------------------- Body end
    ...
    public HttpResponse execute() {
        ...
        // 初始化 connection
        this.httpConnection = HttpConnection.create(url, method).setConnectionAndReadTimeout(timeout).header(Header.CHAESET, this.charset, true)
            .header(this.headers);
