package com.meila.common.excel;
...
public class ExcelUtils {
     ...
     */
    public static void exportExcelByObject(List objList, Class objClass, String sheetTitle, String firstTitle, String[] secondTitle, String[] strBody,
        String outputPath) {
        // 初始化工作簿
        HSSFWorkbook workbook = initWorkbook(objList, objClass, sheetTitle, firstTitle, secondTitle, strBody);
        // 保存Excel文件
     ...
     */
    private static HSSFWorkbook initWorkbook(List objList, Class objClass, String sheetTitle, String firstTitle, String[] secondTitle,
        String[] strBody) {
        // 创建工作簿（Excel文件）
        ...
        sheet.addMergedRegion(new Region(0, (short) 0, 0, (short) (strBody.length + 1)));
     ...
     */
    private static void createFirstTitle(HSSFWorkbook workbook, HSSFSheet sheet, String strTitle) {
     ...
     * @param strTitle : sheet头信息列表(sheet第一行各列值)
     */
    private static void createSecondTitle(HSSFWorkbook workbook, HSSFSheet sheet, String[] strTitle) {
     ...
     * @param strBody : Sheet各列的取值方法名（各列的值在objClass中get方法名称）
     */
    private static void createBody(HSSFWorkbook workbook, List objList, Class objClass, HSSFSheet sheet, String[] targetMethod) {
    ...
    /**
     * 解析流程中excel文件,业务逻辑函数请在上面新增方法 by reese 2015-7-30
     * 
     * @param stream
     * @return
     * @throws Exception
    ...
    public static List<Map<String, String>> getDataFromFile(InputStream stream) throws Exception {
        ...
        try {
            ...
            for (int rowNum = 1; rowNum <= sheet.getPhysicalNumberOfRows() - 1; rowNum++) {
                ...
                if (null == aRow || aRow.getCell(0) == null || aRow.getCell(0).getRichStringCellValue() == null
                        || StringUtils.isBlank(aRow.getCell(0).getRichStringCellValue().toString())) {
                    break;
                }
