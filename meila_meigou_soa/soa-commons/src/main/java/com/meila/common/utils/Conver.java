...
public class Conver {
    ...
    public static <T> Integer[] toIntArray(boolean isIgnoreConvertError, T... values) {
        ...
        for (int i = 0; i < values.length; i++) {
            ...
            if (null == v && isIgnoreConvertError == false) {
                throw new UtilException(StringUtils.format("Convert [{}] to Integer error!", values[i]));
            }
            ints[i] = v;
        }
        return ints;
    ...
    public static <T> Long[] toLongArray(boolean isIgnoreConvertError, T... values) {
        ...
        for (int i = 0; i < values.length; i++) {
            ...
            if (null == v && isIgnoreConvertError == false) {
                throw new UtilException(StringUtils.format("Convert [{}] to Long error!", values[i]));
            }
            longs[i] = v;
        }
        return longs;
    ...
    public static <T> Double[] toDoubleArray(boolean isIgnoreConvertError, T... values) {
        ...
        for (int i = 0; i < values.length; i++) {
            ...
            if (null == v && isIgnoreConvertError == false) {
                throw new UtilException(StringUtils.format("Convert [{}] to Double error!", values[i]));
            }
            doubles[i] = v;
        }
        return doubles;
    ...
    public static <T> Float[] toFloatArray(boolean isIgnoreConvertError, T... values) {
        ...
        for (int i = 0; i < values.length; i++) {
            ...
            if (null == v && isIgnoreConvertError == false) {
                throw new UtilException(StringUtils.format("Convert [{}] to Float error!", values[i]));
            }
            floats[i] = v;
        }
        return floats;
    ...
    public static <T> Boolean[] toBooleanArray(boolean isIgnoreConvertError, T... values) {
        ...
        for (int i = 0; i < values.length; i++) {
            ...
            if (null == v && isIgnoreConvertError == false) {
                throw new UtilException(StringUtils.format("Convert [{}] to Boolean error!", values[i]));
            }
            bools[i] = v;
        }
        return bools;
