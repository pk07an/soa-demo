...
public final class Props extends Properties {
    ...
    public Props(String pathBaseClassLoader) {
        ...
        if (url == null) {
            throw new RuntimeException(StringUtils.format("Can not find properties file: [{}]", pathBaseClassLoader));
        }
        this.load(url);
    }
    ...
    public Props(File propertiesFile) {
        ...
        if (url == null) {
            throw new RuntimeException(StringUtils.format("Can not find Setting file: [{}]", propertiesFile.getAbsolutePath()));
        }
        this.load(url);
    }
