...
public class InjectUtil {
    ...
    public static <T> void injectFromRequest(T model, String modelName, javax.servlet.ServletRequest request, boolean isWithModelName) {
        ...
        for (Method method : methods) {
            ...
            final String fieldName = StringUtils.getGeneralField(methodName);
            final String paramName = isWithModelName ? (modelName + StringUtils.DOT + fieldName) : fieldName;
            ...
            try {
                ...
                throw new UtilException(StringUtils.format("Inject [{}] error!", paramName), e);
            }
        }
    }
    ...
    public static <T> void injectFromMap(T model, Map<?, ?> map) {
        ...
        for (Method method : methods) {
            ...
            String fieldName = StringUtils.getGeneralField(methodName);
            ...
            try {
                ...
                throw new UtilException(StringUtils.format("Inject [{}] error!", fieldName), e);
            }
        }
    }
    ...
    public static <T> Map<String, Object> toMap(T model, boolean isOnlyBasicType) {
        ...
        for (Method method : methods) {
            ...
            try {
                ...
                throw new UtilException(StringUtils.format("Inject map [{}] error!", fieldName), e);
            }
            if (value != null) {
