...
import com.meila.common.utils.CharsetUtil;
...
public class HttpResponse extends HttpBase<HttpResponse> {
    ...
    public byte[] bodyBytes() {
        ...
        return StringUtils.bytes(body, charset);
    }
    ...
    private HttpResponse unzip() {
        ...
        if (contentEncoding != null && contentEncoding().equals("gzip")) {
            if (body != null) {
                ...
                try {
                    ByteArrayInputStream in = new ByteArrayInputStream(StringUtils.bytes(this.body, charset));
