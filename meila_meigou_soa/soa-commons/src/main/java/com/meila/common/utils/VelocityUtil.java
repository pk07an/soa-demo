...
import com.meila.common.exceptions.NotInitedException;
...
public class VelocityUtil {
    ...
    public static void toFile(Template template, VelocityContext context, String destPath) {
        ...
        try {
            ...
            throw new UtilException(StringUtils.format("Write Velocity content to [{}] error!", destPath), e);
        } finally {
    ...
    public static void toWriter(String templateFileName, javax.servlet.http.HttpServletRequest request,
        ...
        try {
            ...
            throw new UtilException(StringUtils.format("Write Velocity content template by [{}] to response error!", templateFileName), e);
        } finally {
            FileUtil.close(writer);
        }
    }
