...
import com.meila.common.exceptions.Exceptions;
...
public class JaxbMapper {
     ...
     * Java Object->Xml with encoding.
     */
    public static String toXml(Object root, @SuppressWarnings("rawtypes") Class clazz, String encoding) {
        try {
     ...
     */
    public static String toXml(Collection<?> root, String rootName, @SuppressWarnings("rawtypes") Class clazz, String encoding) {
        try {
