...
import com.meila.common.exceptions.HttpException;
import com.meila.common.http.ssl.DefaultTrustManager;
import com.meila.common.http.ssl.TrustAnyHostnameVerifier;
import com.meila.common.log.XLog;
import com.meila.common.utils.Func;
import com.meila.common.utils.StringUtils;
import com.meila.common.utils.URLUtil;
import com.meila.common.utils.Validator;
...
public class HttpConnection {
        ...
        if (CollectionUtil.isNotEmpty(headers)) {
            ...
            for (Entry<String, List<String>> entry : headers.entrySet()) {
                ...
                for (String value : entry.getValue()) {
                    this.header(name, StringUtils.nullToEmpty(value), false);
                }
            }
        }
        return this;
    ...
    public InputStream getInputStream() throws IOException {
        ...
        if (StringUtils.isBlank(setCookie) == false) {
