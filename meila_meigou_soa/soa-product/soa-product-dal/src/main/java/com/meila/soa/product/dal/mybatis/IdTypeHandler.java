package com.meila.soa.product.dal.mybatis;
...
public final class IdTypeHandler extends BaseTypeHandler<String> {
    ...
    public static void main(String[] args) {
        /**
         * System.out.println("1:" + decode("9")); long l = 8999931455676754L; String e = encode(l);
         * System.out.println(l + ": " + e + ", " + decode(e)); l = 676254L; e = encode(l); System.out.println(l + ": "
         * + e + ", " + decode(e)); l = 676255L; e = encode(l); System.out.println(l + ": " + e + ", " + decode(e)); l =
         * 676262L; e = encode(l); System.out.println(l + ": " + e + ", " + decode(e));
         */
