...
public class DubboBatchOrderPackage extends BasicSeriModel{
    ...
    private List<DubboOrderPackageItem> items;
    ...
    public List<DubboOrderPackageItem> getItems() {
        return items;
    }

    public void setItems(List<DubboOrderPackageItem> items) {
        this.items = items;
    }
}
