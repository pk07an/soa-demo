...
public class ThriftProductService {
  ...
  public interface Iface {
    ...
    public List<com.meila.soa.openapi.thrift.product.model.ThriftPageSimpleProductModel> findTopProductBySellId(long sellerId, int dayNum, int pageNo, int pageSize) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public List<com.meila.soa.openapi.thrift.product.model.ThriftPageSimpleProductModel> recv_findTopProductBySellId() throws org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public static class findTopProductBySellId_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      public List<com.meila.soa.openapi.thrift.product.model.ThriftPageSimpleProductModel> getResult() throws org.apache.thrift.TException {
        if (getState() != org.apache.thrift.async.TAsyncMethodCall.State.RESPONSE_READ) {
          throw new IllegalStateException("Method call not finished!");
        }
        org.apache.thrift.transport.TMemoryInputTransport memoryTransport = new org.apache.thrift.transport.TMemoryInputTransport(getFrameBuffer().array());
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class findTopProductBySellId<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, findTopProductBySellId_args, List<com.meila.soa.openapi.thrift.product.model.ThriftPageSimpleProductModel>> {
      public findTopProductBySellId() {
        super("findTopProductBySellId");
      }
      ...
      public AsyncMethodCallback<List<com.meila.soa.openapi.thrift.product.model.ThriftPageSimpleProductModel>> getResultHandler(final AsyncFrameBuffer fb, final int seqid) {
        final org.apache.thrift.AsyncProcessFunction fcall = this;
        return new AsyncMethodCallback<List<com.meila.soa.openapi.thrift.product.model.ThriftPageSimpleProductModel>>() { 
          public void onComplete(List<com.meila.soa.openapi.thrift.product.model.ThriftPageSimpleProductModel> o) {
            findTopProductBySellId_result result = new findTopProductBySellId_result();
            result.success = o;
            try {
              fcall.sendResponse(fb,result, org.apache.thrift.protocol.TMessageType.REPLY,seqid);
      ...
      public void start(I iface, findTopProductBySellId_args args, org.apache.thrift.async.AsyncMethodCallback<List<com.meila.soa.openapi.thrift.product.model.ThriftPageSimpleProductModel>> resultHandler) throws TException {
  ...
  public static class findTopProductBySellId_result implements org.apache.thrift.TBase<findTopProductBySellId_result, findTopProductBySellId_result._Fields>, java.io.Serializable, Cloneable, Comparable<findTopProductBySellId_result>   {
    ...
    public List<com.meila.soa.openapi.thrift.product.model.ThriftPageSimpleProductModel> success; // required
    ...
    public findTopProductBySellId_result(
      List<com.meila.soa.openapi.thrift.product.model.ThriftPageSimpleProductModel> success)
    {
      this();
      this.success = success;
    }
    ...
    public findTopProductBySellId_result(findTopProductBySellId_result other) {
      if (other.isSetSuccess()) {
        List<com.meila.soa.openapi.thrift.product.model.ThriftPageSimpleProductModel> __this__success = new ArrayList<com.meila.soa.openapi.thrift.product.model.ThriftPageSimpleProductModel>(other.success.size());
        for (com.meila.soa.openapi.thrift.product.model.ThriftPageSimpleProductModel other_element : other.success) {
          __this__success.add(new com.meila.soa.openapi.thrift.product.model.ThriftPageSimpleProductModel(other_element));
        }
        this.success = __this__success;
      }
    }
    ...
    public java.util.Iterator<com.meila.soa.openapi.thrift.product.model.ThriftPageSimpleProductModel> getSuccessIterator() {
      return (this.success == null) ? null : this.success.iterator();
    }

    public void addToSuccess(com.meila.soa.openapi.thrift.product.model.ThriftPageSimpleProductModel elem) {
      if (this.success == null) {
        this.success = new ArrayList<com.meila.soa.openapi.thrift.product.model.ThriftPageSimpleProductModel>();
      }
      this.success.add(elem);
    }

    public List<com.meila.soa.openapi.thrift.product.model.ThriftPageSimpleProductModel> getSuccess() {
      return this.success;
    }

    public findTopProductBySellId_result setSuccess(List<com.meila.soa.openapi.thrift.product.model.ThriftPageSimpleProductModel> success) {
      this.success = success;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case SUCCESS:
        if (value == null) {
          ...
          setSuccess((List<com.meila.soa.openapi.thrift.product.model.ThriftPageSimpleProductModel>)value);
        }
        break;
    ...
    private static class findTopProductBySellId_resultStandardScheme extends StandardScheme<findTopProductBySellId_result> {
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new ArrayList<com.meila.soa.openapi.thrift.product.model.ThriftPageSimpleProductModel>(_list48.size);
                  com.meila.soa.openapi.thrift.product.model.ThriftPageSimpleProductModel _elem49;
                  for (int _i50 = 0; _i50 < _list48.size; ++_i50)
                  {
                    _elem49 = new com.meila.soa.openapi.thrift.product.model.ThriftPageSimpleProductModel();
                    _elem49.read(iprot);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, findTopProductBySellId_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          ...
          {
            oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, struct.success.size()));
            for (com.meila.soa.openapi.thrift.product.model.ThriftPageSimpleProductModel _iter51 : struct.success)
            {
              _iter51.write(oprot);
            }
            oprot.writeListEnd();
    ...
    private static class findTopProductBySellId_resultTupleScheme extends TupleScheme<findTopProductBySellId_result> {
      ...
      public void write(org.apache.thrift.protocol.TProtocol prot, findTopProductBySellId_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.isSetSuccess()) {
          {
            oprot.writeI32(struct.success.size());
            for (com.meila.soa.openapi.thrift.product.model.ThriftPageSimpleProductModel _iter52 : struct.success)
            {
              _iter52.write(oprot);
            }
          }
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new ArrayList<com.meila.soa.openapi.thrift.product.model.ThriftPageSimpleProductModel>(_list53.size);
            com.meila.soa.openapi.thrift.product.model.ThriftPageSimpleProductModel _elem54;
            for (int _i55 = 0; _i55 < _list53.size; ++_i55)
            {
              _elem54 = new com.meila.soa.openapi.thrift.product.model.ThriftPageSimpleProductModel();
              _elem54.read(iprot);
    ...
    private static class findShopBySellerId_resultStandardScheme extends StandardScheme<findShopBySellerId_result> {
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new ArrayList<com.meila.soa.openapi.thrift.product.model.ThriftShopModel>(_list64.size);
                  com.meila.soa.openapi.thrift.product.model.ThriftShopModel _elem65;
                  for (int _i66 = 0; _i66 < _list64.size; ++_i66)
                  {
                    _elem65 = new com.meila.soa.openapi.thrift.product.model.ThriftShopModel();
                    _elem65.read(iprot);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, findShopBySellerId_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          ...
          {
            oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, struct.success.size()));
            for (com.meila.soa.openapi.thrift.product.model.ThriftShopModel _iter67 : struct.success)
            {
              _iter67.write(oprot);
            }
            oprot.writeListEnd();
    ...
    private static class findShopBySellerId_resultTupleScheme extends TupleScheme<findShopBySellerId_result> {
      ...
      public void write(org.apache.thrift.protocol.TProtocol prot, findShopBySellerId_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.isSetSuccess()) {
          {
            oprot.writeI32(struct.success.size());
            for (com.meila.soa.openapi.thrift.product.model.ThriftShopModel _iter68 : struct.success)
            {
              _iter68.write(oprot);
            }
          }
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new ArrayList<com.meila.soa.openapi.thrift.product.model.ThriftShopModel>(_list69.size);
            com.meila.soa.openapi.thrift.product.model.ThriftShopModel _elem70;
            for (int _i71 = 0; _i71 < _list69.size; ++_i71)
            {
              _elem70 = new com.meila.soa.openapi.thrift.product.model.ThriftShopModel();
              _elem70.read(iprot);
