...
public class ModelB {
    ...
    private List<Long> flongList1;

    private List<Long> flongList2;

    public List<Long> getFlongList1() {
        return flongList1;
    }

    public void setFlongList1(List<Long> flongList1) {
        this.flongList1 = flongList1;
    }

    public List<Long> getFlongList2() {
        return flongList2;
    }

    public void setFlongList2(List<Long> flongList2) {
        this.flongList2 = flongList2;
    }
    ...
    public int hashCode() {
        ...
        result = prime * result + ((flongList1 == null) ? 0 : flongList1.hashCode());
        result = prime * result + ((flongList2 == null) ? 0 : flongList2.hashCode());
    ...
    public boolean equals(Object obj) {
        ...
        if (flong2 == null) {
            ...
            return false;
        if (flongList1 == null) {
            if (other.flongList1 != null)
                return false;
        } else if (!flongList1.equals(other.flongList1))
            return false;
        if (flongList2 == null) {
            if (other.flongList2 != null)
                return false;
        } else if (!flongList2.equals(other.flongList2))
            return false;
